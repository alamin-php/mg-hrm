    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#" class="active"><i class="fa fa-home"></i> Section</a></li>
            </ol>
        </section>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center">Add a new section</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('section.store') }}" method="post" id="add_form">
                        @csrf
                        <div class="form-group">
                            <label for="sectionName">Section name</label>
                            <input type="text" class="form-control form-control-sm" name="section_name" id="SectionName"
