...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#" class="active"><i class="fa fa-home"></i> Unit</a></li>
            </ol>
        </section>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center">Add a new unit</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('unit.store') }}" method="post" id="add_form">
                        @csrf
                        <div class="form-group">
                            <label for="unitName">Unit name</label>
                            <input type="text" class="form-control input-sm" name="unit_name" id="unitName"
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center">Edit unit data</h4>
                </div>
                <div class="modal-body">
